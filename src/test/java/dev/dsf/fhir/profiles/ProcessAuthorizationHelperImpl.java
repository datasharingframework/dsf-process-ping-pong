...
public class ProcessAuthorizationHelperImpl implements ProcessAuthorizationHelper
{
			...
			Predicate<Coding> organizationRoleExists)
	{
		return switch (coding.getCode())
		{
			...
			case ProcessAuthorization.Codes.LOCAL_ORGANIZATION -> Organization.fromRecipient(coding,
					organizationWithIdentifierExists);

			case ProcessAuthorization.Codes.LOCAL_ROLE -> Role.fromRecipient(coding, organizationWithIdentifierExists,
					organizationRoleExists);
