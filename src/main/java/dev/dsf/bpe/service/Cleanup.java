...
public class Cleanup
{
	...
	private final dev.dsf.bpe.util.Process process;

	public Cleanup(ProcessPluginApi api, Process process)
	{
		this.api = api;
			...
			catch (ProcessingException e)
			{
				if (e.getCause() instanceof SocketTimeoutException)
				{
					ProcessError error = new ProcessError(process.toString(),
							ConstantsPing.CODESYSTEM_DSF_PING_PROCESS_STEPS_VALUE_CLEANUP,
