...
public class DownloadResourceSizeGenerator
{
	public static Task.ParameterComponent create(int sizeBytes)
	{
		...
		param.setValue(new IntegerType(sizeBytes)).getType().addCoding(new Coding(ConstantsPing.CODESYSTEM_DSF_PING, ConstantsPing.CODESYSTEM_DSF_PING_VALUE_DOWNLOAD_RESOURCE_SIZE_BYTES, null));
		return param;
	}
}
